...
public abstract class JJKLoadAsCircularBitmap {

    private JJKLoadAsCircularBitmap() throws IllegalAccessException {
        throw new IllegalAccessException("Can not instantiate an abstract class");
    }

    // End Point: Load Bitmap into ImageView
    public static void loadImageAsBitmap(@NonNull final Context context,
